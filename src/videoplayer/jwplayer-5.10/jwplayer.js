...
(function(jwplayer) {
	...
	jwplayer.api = function(container) {
		...
		this.getBandwidth = function() {
			return this.callInternal('jwGetBandwidth');
		};
		this.getBandwidthCalculated = function() {
			return this.callInternal('jwGetBandwidthCalculated');
		};
		this.getLevel = function() {
			return this.callInternal('jwGetLevel');
		};
		this.getBufferTime = function() {
			return this.callInternal('jwGetBufferTime');
		};
		this.setBufferTime = function(bufferTime) {
			return this.callInternal('jwSetBufferTime', bufferTime);
		};
		this.getBandwidthPercentage = function() {
			return this.callInternal('jwGetBandwidthPercentage');
		};
		this.setBandwidthPercentage = function(bandwidthPercentage) {
			this.callInternal('jwSetBandwidthPercentage', bandwidthPercentage);
			return this;
		};
		this.isReady = function() {
			return _playerReady;
		};
		this.waitingFor = function() {
			return this.callInternal('jwWaitingFor');
		};
		/** End Simon Mod **/
		...
		this.resize = function(width, height) {
			if (this.renderingMode == "html5") {
				...
				if (wrapper){
					wrapper.style.width = (width > 0) ? width + "px" : width;
					wrapper.style.height = (height > 0) ? height + "px" : height;
				}
			}
			return this;
		};
...
(function(jwplayer) {
	...
	jwplayer.embed.logo = function(logoConfig, mode, id) {
		...
		function _getStyle() {
			...
			_imageStyle.display = _settings.hide ? "none" : "none";
